...
def build_model():
    ...
    model['vsc']['UIC_sig'] = [
        ...
        [
            ...
            0.0,
            0.1,
            0,                 # perfect_tracking=0: UIC's built-in droop ACTIVE (not cancelled)
            0.01,
        ],
    ]
    ...
    model['windturbine'] = {
        'WindTurbine': [
            ...
            [
                ...
                0.70000,
                50.0,
                0, 0.75, 0.05,   # droop_enable=0: outer WT droop OFF -> use UIC's built-in droop (perfect_tracking=0)
            ],
        ],
    }
